  ...
  const loadConflicts = async () => {
    try {
      ...
      const [conflictsRes, summaryRes] = await Promise.all([
        conflictsAPI.getAll({ property_id: 1, active_only: true }),
              ...
              <div className="conflict-details">
                ...
                {selectedConflict.overlap_start && (
                  <div className="overlap-info">
                    ...
                    <p>
                      {formatDate(selectedConflict.overlap_start)} até{' '}
                      {formatDate(selectedConflict.overlap_end)}
                    </p>
