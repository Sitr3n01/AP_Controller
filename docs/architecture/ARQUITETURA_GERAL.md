# Arquitetura Geral - SENTINEL

Visao geral da arquitetura do sistema SENTINEL.

---

## Visao Geral

SENTINEL e um sistema de gestao de imoveis para aluguel de curta temporada (Airbnb/Booking.com) construido com arquitetura moderna em camadas.
